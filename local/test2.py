...
def process_cards(tarjetas, key, bucket, codigo_producto):
    ...
    for id_unico, info in tarjetas.items():
        ...
        nombre_archivo = f"outputs2/lineas_{id_unico}.txt"
...
archivo = "018953940.pdf"
ruta_archivo = "C:\\Users\\Diterod\\Desktop\\pdfplumber_files\\SERIE_23032026\\Publicacion\\018953940.pdf"
key = ruta_archivo
